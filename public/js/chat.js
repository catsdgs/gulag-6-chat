...
socket.on('newMessage', function(message){
  ...
  var words = ['nerve', 'cheese', 'territory', 'volcano', 'afternoon', 'cave', 'salt', 'badge', 'bear', 'bucket', 'account', 'stocking', 'achiever', 'caption', 'face', 'railway', 'spot', 'mice', 'geese', 'regret', 'stem', 'limit', 'match', 'pen', 'eggs', 'route', 'trousers', 'drawer', 'zebra', 'sidewalk', 'flock', 'cakes', 'steam', 'board', 'pest', 'plane', 'birthday', 'vessel', 'health', 'oven', 'cars', 'knee', 'friction', 'skate', 'walk', 'pencil', 'pipe', 'writing', 'division', 'hospital', 'shelf', 'boot', 'lace', 'town', 'north', 'planes', 'ticket', 'flower', 'art', 'ladybug', 'horses', 'scarf', 'ghost', 'thought', 'yarn', 'attack', 'company', 'muscle', 'roof', 'reason', 'field', 'anger', 'scissors', 'plough', 'sticks', 'lock', 'mother', 'day', 'orange', 'temper', 'chance', 'nation', 'songs', 'zephyr', 'porter', 'tomatoes', 'skirt', 'relation', 'statement', 'corn', 'seashore', 'vacation', 'window', 'event', 'flag', 'industry', 'minister', 'front', 'spark', 'fold', 'person', 'whistle', 'air', 'son', 'grape', 'potato', 'pot', 'authority', 'calculator', 'fork', 'paper', 'chicken', 'smell', 'gun', 'root', 'branch', 'sleep', 'sweater', 'flowers', 'adjustment', 'pocket', 'cover', 'holiday', 'ray', 'bikes', 'turn', 'respect', 'shape', 'swim', 'color', 'mailbox', 'zinc', 'system', 'quiver', 'bedroom', 'self', 'fireman', 'transport', 'pet', 'alarm', 'name', 'table', 'coach', 'shoe', 'grade', 'store', 'treatment', 'lip', 'vein', 'iron', 'watch', 'rate', 'move', 'snakes', 'popcorn', 'need', 'woman', 'picture', 'pleasure', 'top', 'wish', 'question', 'sun', 'deer', 'can', 'building', 'book', 'trail', 'digestion', 'basketball', 'actor', 'wheel', 'cobweb', 'drain', 'wood', 'furniture', 'plate', 'hammer', 'fruit', 'interest', 'spoon', 'spring', 'engine', 'bird', 'card', 'condition', 'sense', 'loaf', 'berry', 'purpose', 'boundary', 'cast', 'representative', 'bubble', 'song', 'night', 'mine', 'page', 'receipt', 'thumb', 'yak', 'tramp', 'coal', 'driving', 'distance', 'collar', 'hair', 'rail', 'boy', 'linen', 'stick', 'measure', 'visitor', 'amount', 'low', 'egg', 'knot', 'mark', 'baby', 'look', 'horn', 'dock', 'cattle', 'bells', 'elbow', 'sleet', 'notebook', 'shame', 'water', 'milk', 'jellyfish', 'shoes', 'pancake', 'back', 'income', 'carriage', 'balance', 'sand', 'crook', 'trade', 'crack', 'soda', 'soup', 'science', 'plant', 'crow', 'fear', 'committee', 'sheet', 'throne', 'degree', 'fowl', 'payment', 'effect', 'crown', 'meal', 'chess', 'crime', 'believe', 'hall', 'hand', 'wire', 'cows', 'nose', 'property', 'earthquake', 'smash', 'sponge', 'juice', 'insurance', 'sound', 'giraffe', 'camp', 'writer', 'recess', 'hole', 'minute', 'man', 'hour', 'jar', 'selection', 'reading', 'unit', 'structure', 'thrill', 'stomach', 'pigs', 'party', 'trains', 'advice', 'friend', 'hate', 'humor', 'experience', 'rabbits', 'cent', 'things', 'copper', 'ice', 'title'];
